...
- **Do NOT treat this as a production crypto library** — it is a teaching demo of mode behavior and failure cases, not hardened code.

## Live Demo

**[systemslibrarian.github.io/crypto-lab-aes-modes](https://systemslibrarian.github.io/crypto-lab-aes-modes/)**
...
```bash
git clone https://github.com/systemslibrarian/crypto-lab-aes-modes
...
- [crypto-lab-shadow-vault](https://systemslibrarian.github.io/crypto-lab-shadow-vault/) — ChaCha20-Poly1305 AEAD as an AES-GCM alternative.
- [crypto-lab-iron-letter](https://systemslibrarian.github.io/crypto-lab-iron-letter/) — hybrid public-key encryption wrapping AES-256-GCM.
- [crypto-lab-iron-serpent](https://systemslibrarian.github.io/crypto-lab-iron-serpent/) — the Serpent block cipher, an AES finalist.
- [crypto-lab-ascon](https://systemslibrarian.github.io/crypto-lab-ascon/) — lightweight AEAD for constrained devices.
- [crypto-lab-padding-oracle](https://systemslibrarian.github.io/crypto-lab-padding-oracle/) — the CBC padding oracle attack in depth.
